-- Optimize search_similar to use vector indexes efficiently
-- The previous version used WHERE clauses on computed similarity, forcing full table scans.
-- This version uses ORDER BY + LIMIT to leverage IVFFlat indexes.

-- Simple test functions to isolate performance
create or replace function test_node_search(
