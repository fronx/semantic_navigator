...
- [Chunk Text Depth Precision](investigations/chunk-text-depth-precision-2026-02-19.md) - Peripheral card text invisible at certain zoom levels due to linear depth buffer precision limits; resolved via logarithmic depth buffer with logdepthbuf shader chunks in custom ShaderMaterial
